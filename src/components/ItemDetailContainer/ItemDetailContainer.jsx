...
let libros = [
  ...
  },
  {
    ...
    descripcion:
      "Sumérjase en el electrizante mundo de Mert & Marcus, el dúo fotográfico cuya creatividad inagotable está detrás de la imagen pública de algunas de las marcas y personalidades más relevantes de nuestro tiempo, de Miu Miu a Angelina Jolie y de Givenchy a Gisele Bündchen. Esta Edición de Coleccionista en tamaño XXL incluye unas 300 fotografías de su hiperglamuroso y brillante repertorio.",
    precio: "US$1750",
    stock: 2,
...

  {
    ...
    nombre:
      "100 Interiors Around the World. Un viaje por el mundo de los interiores",
    descripcion:
